# 🧠 CodeImpact - Predict Breaking Changes Before You Deploy
...
### 🧪 Untested Danger Zone Identification
...
### Step 2: Explore Your Code Graph
...
2. Select **"Analyze Impact"**
3. CodeImpact will highlight all affected nodes in **red** (breaking changes) and **yellow** (warning zones)

### Step 4: Review Untested Areas
...
- Avoid network drives — copy your project to your local hard drive
...
### Getting Slow on Large Projects
...
### Will CodeImpact work with my legacy code?
...
### Can I use CodeImpact with multiple projects?
